    ...
    controller.studio.runHandlers = function(type, convo, cb_or_sub, cb) {
        ...
        if (!convo.context.script_name) {
            ...
            switch (type) {
                ...
                break;
                case 'validate':
                    handlers = answer_hooks[convo.context.script_name][cb_or_sub] ? answer_hooks[convo.context.script_name][cb_or_sub].slice() : [];
                break;
                case 'beforeThread':
                    handlers = thread_hooks[convo.context.script_name][cb_or_sub] ? thread_hooks[convo.context.script_name][cb_or_sub].slice() : [];
                break;
